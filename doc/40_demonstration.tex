...
\begin{enumerate}
    ...
    \item Add the topic value `/set\_joint\_trajectory/points[0]/positions[0]` which is the value from \GLS{eeros}.
\end{enumerate}
...
For demonstration purposes, a simple \texttt{JointStateSubscriber} is implemented in an \GLS{eeros} Project.
...
\subsubsection[JointTrajectoryPose-Message]{The JointTrajectory Message Format} \label{sec:deom-publisher-message}
